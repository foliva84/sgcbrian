...
try {
    ...
    if (
        ...
        $reintegro_id_archivo = isset($_POST["reintegro_id_archivo"])?$_POST["reintegro_id_archivo"]:'';  // Caso del archivo
    ...
    if (!move_uploaded_file(
        ...
        sprintf('../a_edc6c6cba6ee5c14f146448b9fe908435d9b665f_repo_reintegros/%s.%s',$archivo_encriptado,$ext))) 
    {
    ...
    Archivo::guardar_reintegros($archivo_nombre, $archivo_extension, $archivo_encriptado, $reintegro_id_archivo);    
