...
try {
   // Obtener el id del archivo
    ...
    $archivo_arr = Archivo::obtener_nombre_reintegros($archivo_id);
    
    $nombre_archivo = $archivo_arr["archivo_encriptado"];
    $extension_archivo = $archivo_arr["archivo_extension"];
    
    Archivo::eliminar_reintegros($archivo_id);
    
    unlink("../a_edc6c6cba6ee5c14f146448b9fe908435d9b665f_repo_reintegros/" . $nombre_archivo . "." . $extension_archivo);
