...
$reintegro_id_archivo = isset($_POST["reintegro_id_archivo"])?$_POST["reintegro_id_archivo"]:'';
...
switch($opcion){
    ...
    case 'grilla_listar':
        grilla_listar($reintegro_id_archivo, $permisos);
        break;
...
function grilla_listar($reintegro_id_archivo, $permisos){
    

    $archivos = Archivo::listar_reintegros($reintegro_id_archivo);
    ...
    $archivos_reintegros_borrar = array_search('archivos_reintegros_borrar', array_column($permisos, 'permiso_variable'));
    if (!empty($archivos_reintegros_borrar) || ($archivos_reintegros_borrar === 0)) {
