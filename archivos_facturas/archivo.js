...
function uploadFile(){
	var file = _("upfile").files[0];
        ...
        var factura_id_archivo = $("#factura_id_archivo").val();
        
	var formdata = new FormData();
	formdata.append("upfile", file);
        
        formdata.append("factura_id_archivo", factura_id_archivo);
...
var vista_archivo = function(archivo){
    window.open("../a_edc6c6cba6ee5c14f146448b9fe908435d9b665f_repo_facturas/" + archivo , "_blank");
};
...
var grilla_listar = function(){
    var parametros = {
        ...
        "factura_id_archivo": $("#factura_id_archivo").val()
    };
    $.ajax({
            dataType: "html",
            method: "POST",
