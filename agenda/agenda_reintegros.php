<?php 
    ...
    $agenda_reintegros_ver = array_search('agenda_reintegros_ver', array_column($permisos, 'permiso_variable'));
    if (empty($agenda_reintegros_ver) && ($agenda_reintegros_ver !== 0)) {
        header("location:../_errores/401.php");
    } else {
?>
    <?php $pagina = "Agenda Reintegros"; ?>
        ...
        <div class="panel-body hidden" id="panel_formulario_asignacion">
            <div class="row">
                <form  id="formulario_asignacion" name="formulario_asignacion">
                    ...
                    <input type="hidden" id="agenda_reintegro_id" name="agenda_reintegro_id" value="0">
                    <input type="hidden" id="opcion" name="opcion" value="formulario_asignacion">
                    <div class="col-sm-12">
                        <div class="card-box-form">
                            <div class="row">
                                <h4 class="m-t-0 m-b-20 header-title"><b>Asignar Reintegro</b></h4>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" id="btn_asignar_reintegro" class="btn btn-success waves-effect waves-light"><span>Asignar Reintegro</span> </button>
                                    </div>
                                </div>       
                            </div>
                        </div>
        ...
        <div class="panel-body hidden" id="panel_formulario_reasignacion">
            <div class="row">
                <form  id="formulario_reasignacion" name="formulario_reasignacion">
                    ...
                    <input type="hidden" id="agenda_reintegro_id_r" name="agenda_reintegro_id_r" value="0">
                    <input type="hidden" id="opcion" name="opcion" value="formulario_reasignacion" readonly="readonly">
                    <div class="col-sm-12">
                        <div class="card-box-form">
                            <div class="row">
                                <h4 class="m-t-0 m-b-20 header-title"><b>Re-Asignar Reintegro</b></h4>
                                <div class="col-md-2">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" id="btn_reAsignar_reintegro" class="btn btn-success waves-effect waves-light"><span>Re-Asignar Reintegro</span> </button>
                                    </div>
                                </div>       
                            </div>
                        </div>
        ...
        <div class="panel-body" id="panel_grilla">   
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    <select name="reintegro_estado_id_b" class="form-control" id="reintegro_estado_id_b"></select>
                </div>
                <div class="form-group col-md-3">
    ...
    <script src="agenda_reintegros.js?random=<?php echo uniqid(); ?>"></script>
