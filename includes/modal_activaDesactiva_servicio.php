        ...
        <div class="modal-dialog">
            <div class="modal-content">    
                <div class="modal-body">
                    <input type="hidden" id="id_modalBaja" name="id_modalBaja" value="0" />
                    <h4>¿Está seguro que desea cancelar este servicio?</h4>
                    <hr>
                    <h4>Nota:</h4>
                    <p>Los servicios cancelados no aparecen en los reportes.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">No</button>
                    <button type="submit" class="btn btn-primary waves-effect waves-light" >Sí, cancelar</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
...
<form id="formulario_habilita" method="POST" action="">
    <div id="ventana_modal_habilita" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
        <div class="modal-dialog">
            <div class="modal-content">    
                <div class="modal-body">
                    <input type="hidden" id="id_modalAlta" name="id_modalAlta" value="0" />
                    <h4>¿Está seguro que desea volver a habilitar el servicio?</h4>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">No</button>
