...
// Listar de Estados de Casos
function listar_estadosCasos() {

    var parametros = {
        "opcion": 'listar_estadosCasos'
    };

    var miselect = $("#caso_estado_id");
...
$(document).keypress(function (e) {
    if(e.keyCode === 13){
        ...
        grilla_listar();
        return false; //evita el submit del formulario para exportar a excel
    }
});
...
var grilla_listar = function(){
    ...
    let caso_estado_id = $("#caso_estado_id option:selected").val();
    let caso_fee_id = $("#caso_fee_id option:selected").val();
