...
<?php $pagina = "Reporte_Reintegros_Pago"; ?>
...
<div class="panel panel-default users-content">
    ...
    <div class="panel-body" id="panel_grilla">
        <div class="row">
            <form  id="formulario_reporte" name="formulario_reporte" action='reporte_reintegros_pago_cb.php' method="post">
                <!-- Acción del formulario en opcion  -->
                <input type="hidden" id="opcion" name="opcion" value="informar_pago" readonly="readonly">
                <div class="col-md-12">
                    <div class="card-box-form">
                        <div class="row">
                            <h4 class="m-t-0 m-b-20 header-title"><b>Pago de Reintegros</b></h4>
                            <div class="form-group col-md-2">
                                <input type="text"  name="reintegro_fechaPago" class="form-control"  id="reintegro_fechaPago" placeholder="Fecha de pago" >
                            </div>
                            
                            <div class="col-md-6">
                                <div class="form-group">
                                    <!--<button class="btn btn-primary waves-effect waves-light" type="button" onclick='grilla_listar()'>Listar Resultado</button>-->
                                    <button id="btn_generar_pago" class="btn btn-default waves-effect waves-light" type="submit">Generar Pago de Reintegros</button>
            ...
            <div id="reporte_reintegros_pago"></div>
            <div>
...
<script src="reporte_reintegros_pago.js?random=<?php echo uniqid(); ?>"></script>
