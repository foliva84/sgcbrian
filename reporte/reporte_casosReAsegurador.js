...
var grilla_listar = function(){
    ...
    $.ajax({
            dataType: "html",
            method: "POST",
            url: "reporte_casosReAsegurador_cb.php",
            data: parametros,
    ...
    $.ajax({
            ...
            success:function(data){
                $("#grilla_casos_reAsegurador").html(data);
...
var listar = function(){
    ...
    var table = $("#dt_casos_reAsegurador").DataTable({
        "destroy":true,
        "stateSave": true,
...
var exportar_excel = function(form){
    ...
    $.ajax({
            ...
            complete:
            function () {
                window.location = "reporte_casosReAsegurador_cb.php";
            }
