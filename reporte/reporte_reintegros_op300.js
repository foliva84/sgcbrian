...
function listar_reintegro_estados(){
    ...
    $.ajax({
        type: 'POST',
        dataType:'JSON',
        url: 'reporte_reintegros_op300_cb.php',
        data: parametros,
...
// Exportacion a Excel - funcion para generar el excel a exportar - Utiliza la clase y libreria PHPExcel
...
var exportar_excel = function(form){
    ...
    $.ajax({
            ...
            complete:
            function () {
                window.location = "reporte_reintegros_op300_cb.php";
            }
