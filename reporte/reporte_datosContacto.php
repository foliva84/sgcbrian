...
<?php $pagina = "Reporte_DatosContacto"; ?>
...
<div class="panel panel-default users-content">
    ...
    <div class="panel-body" id="panel_grilla">
        <div class="row">
            <form  id="formulario_reporte" name="formulario_reporte" action='reporte_datosContacto_cb.php' method="post">
                ...
                <div class="col-sm-12">
                    <div class="card-box-form">
                        <div class="row">
                            <h4 class="m-t-0 m-b-20 header-title"><b>Buscador</b></h4>
                            <div class="col-md-3">
            ...
            <div id="grilla_datosContacto"></div> 
        </div>
    </div>
...
<script src="reporte_datosContacto.js"></script> 
