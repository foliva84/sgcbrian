                ...
                <div class="col-sm-12">
                    <div class="card-box-form">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="caso_prestador_id">Ciudad</label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="control-label" for="caso_estado_id">Estado del caso</label>
                                    <select name="caso_estado_id" class="form-control" id="caso_estado_id"></select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <div class="checkbox checkbox-primary">
                                        ...
                                        <label for="caso_anulado">Anulados</label>
                                    </div>
                                </div>
                            </div>
...
<script src="reporte_casosAvanzados.js?random=<?php echo uniqid(); ?>"></script>
