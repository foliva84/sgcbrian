...
<?php $pagina = "Reporte_Reintegros_op300"; ?>
...
<div class="panel panel-default users-content">
    ...
    <div class="panel-body" id="panel_grilla">
        <div class="row">
            <form  id="formulario_reporte" name="formulario_reporte" action='reporte_reintegros_op300_cb.php' method="post">
                <!-- Accion del formulario en opcion  -->
                <input type="hidden" id="opcion" name="opcion" value="exportar_excel" readonly="readonly">
                <div class="col-sm-12">
                    <div class="card-box-form">
                        <div class="row">
                            <h4 class="m-t-0 m-b-20 header-title"><b>Reintegros mayores a USD300</b></h4>
...
<script src="reporte_reintegros_op300.js"></script> 
