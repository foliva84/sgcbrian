...
$caso_anulado = isset($_POST["caso_anulado"])?$_POST["caso_anulado"]:0;
                       ...
                       $caso_anulado)
{
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('A1', 'Caso')
                                    ...
                                    ->setCellValue('F1', 'Fecha Apertura')
                                    ->setCellValue('G1', 'Cliente')
                                    ->setCellValue('H1', 'Voucher')
                                    ->setCellValue('I1', 'Producto')
                                    ->setCellValue('J1', 'Fecha Emision')
                                    ->setCellValue('K1', 'Vig. Desde')
                                    ->setCellValue('L1', 'Vig. Hasta')
                                    ->setCellValue('M1', 'Beneficiario')
                                    ->setCellValue('N1', 'Edad')
                                    ->setCellValue('O1', 'Síntoma')
                                    ->setCellValue('P1', 'Diagnóstico')
                                    ->setCellValue('Q1', 'T.Asistencia')
                                    ->setCellValue('R1', 'Fee')
                                    ->setCellValue('S1', 'Agencia')
                                    ->setCellValue('T1', 'Usuario')
                                    ->setCellValue('U1', 'Presunto USD')
    ...
    header('Content-Disposition: attachment;filename="ReporteSGC.xlsx"');
