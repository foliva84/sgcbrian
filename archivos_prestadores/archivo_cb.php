...
$prestador_id_archivo = isset($_POST["prestador_id_archivo"])?$_POST["prestador_id_archivo"]:'';
...
switch($opcion){
    ...
    case 'grilla_listar':
        grilla_listar($prestador_id_archivo, $permisos);
        break;
...
function grilla_listar($prestador_id_archivo, $permisos){
    

    $archivos = Archivo::listar_prestador($prestador_id_archivo);
    ...
    $archivos_prestadores_borrar = array_search('archivos_prestadores_borrar', array_column($permisos, 'permiso_variable'));
    if (!empty($archivos_prestadores_borrar) || ($archivos_prestadores_borrar === 0)) {
