...
try {
    ...
    if (
        ...
        $prestador_id_archivo = isset($_POST["prestador_id_archivo"])?$_POST["prestador_id_archivo"]:'';  // prestador del archivo
    ...
    if (!move_uploaded_file(
        ...
        sprintf('../a_edc6c6cba6ee5c14f146448b9fe908435d9b665f_repo_prestadores/%s.%s',$archivo_encriptado,$ext))) 
    {
    ...
    Archivo::guardar_prestador($archivo_nombre, $archivo_extension, $archivo_encriptado, $prestador_id_archivo);    
