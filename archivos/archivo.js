...
function uploadFile(){
	var file = _("upfile").files[0];
        ...
        var caso_id_archivo = $("#caso_id_archivo").val();
        
	var formdata = new FormData();
	formdata.append("upfile", file);
        
        formdata.append("caso_id_archivo", caso_id_archivo);
...
var vista_archivo = function(archivo){
    window.open("../a_edc6c6cba6ee5c14f146448b9fe908435d9b665f_repo/" + archivo , "_blank");
};
...
var grilla_listar = function(){
    var parametros = {
        ...
        "caso_id_archivo": $("#caso_id_archivo").val()
    };
    $.ajax({
            dataType: "html",
            method: "POST",
