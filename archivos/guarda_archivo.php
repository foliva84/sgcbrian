...
try {
    ...
    if (
        ...
        $caso_id_archivo = isset($_POST["caso_id_archivo"])?$_POST["caso_id_archivo"]:'';  // Caso del archivo
    ...
    if (!move_uploaded_file(
        ...
        sprintf('../a_edc6c6cba6ee5c14f146448b9fe908435d9b665f_repo/%s.%s',$archivo_encriptado,$ext))) 
    {
    ...
    Archivo::guardar($archivo_nombre, $archivo_extension, $archivo_encriptado, $caso_id_archivo);    
