<?php 
    ...
    $comunicacionesF_ver = array_search('comunicacionesF_ver', array_column($permisos, 'permiso_variable'));
    if (empty($comunicacionesF_ver) && ($comunicacionesF_ver !== 0)) {
        header("location:../_errores/401.php");
    } else {

    $pagina = "ComunicacionF";
...
?>
    ...
    <link href="comunicacionF.css" rel="stylesheet" type="text/css">
    
    
    <!-- Inicio - Panel Formularios y Grilla  -->
     <div class="panel panel-default users-content">
            
            <input type="hidden" id="factura_id_grilla" name="factura_id_grilla" value="<?php echo $factura_id?>" readonly="readonly">
            <?php
                $comunicacionesF_alta = array_search('comunicacionesF_alta', array_column($permisos, 'permiso_variable'));
                if (!empty($comunicacionesF_alta) || ($comunicacionesF_alta === 0)) { 
            ?>
                    ...
                    <div class="col-lg-12">
                        <div class="card-box-form">
                            <form id="formulario_alta" name="formulario_alta">
                                ...
                                <input type="hidden" id="factura_id_n" name="factura_id_n" value="<?php echo $factura_id?>" readonly="readonly">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="comunicacionF_n">Comunicacion</label>
                                        <textarea name="comunicacionF_n" class="form-control" id="comunicacionF_n" rows="5"></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card-box-form">
                            ...
                            <form  id="formulario_modificacion" name="formulario_modificacion">
                                <!-- Acción del formulario en opcion y id de la comunicacionF a modificar -->
                                <input type="hidden" id="comunicacionF_id" name="comunicacionF_id" value="0">
                                <input type="hidden" id="factura_id" name="factura_id" value="<?php echo $factura_id?>">
                                <input type="hidden" id="comunicacionF_fechaIngreso" name="comunicacionF_fechaIngreso">
                                <input type="hidden" id="opcion" name="opcion" value="formulario_modificacion">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="comunicacionF">Comunicacion</label>
                                        <textarea name="comunicacionF" class="form-control" id="comunicacionF" rows="5"></textarea>
                                    </div>
                                </div>
                                <div class="form-group text-right m-b-0">
            ...
            <div class="panel-body" id="panel_grilla">        
                <div id="grilla_comunicacionF"></div>      
            </div>
            <!-- FIN - Grilla de Comunicaciones --> 

            <!-- INICIO - Grilla de Historial de una comunicacionF -->
            <div class="panel-body" id="panel_grilla_historial">   
                <div id="grilla_comunicacionF_historial"></div>      
            </div>
            <!-- FIN - Grilla de Historial de una comunicacionF -->
    ...
    <script src="comunicacionF.js?random=<?php echo uniqid(); ?>"></script>
    </body>
    </html>
<?php } ?>